...
/* (AS) Some function names are modified to match CH56x library functions */

#ifndef _WCH_ISP5XX_H_
#define _WCH_ISP5XX_H_
 ...
 * @return  0-SUCCESS  (!0)-FAILURE
 */
#define FLASH_ROMA_ERASE(StartAddr,Length)           FLASH_EEPROM_CMD( CMD_FLASH_ROM_ERASE, StartAddr, NULL, Length )
 ...
 * @return  0-SUCCESS  (!0)-FAILURE
 */
#define FLASH_ROMA_WRITE(StartAddr,Buffer,Length)    FLASH_EEPROM_CMD( CMD_FLASH_ROM_WRITE, StartAddr, Buffer, Length )
 ...
 * @return  0-SUCCESS  (!0)-FAILURE
 */
#define FLASH_ROMA_VERIFY(StartAddr,Buffer,Length)   FLASH_EEPROM_CMD( CMD_FLASH_ROM_VERIFY, StartAddr, Buffer, Length )

#endif //_WCH_ISP5XX_H_
